<?php
/**
 * src/View/partials/causa_pedir_table_form.php
 * Componente de formulário para a Tabela de Causa de Pedir.
 */
$prefix = 'tabelaCausaPedir';
...
<div class="card card-dark mb-3 query-preview-component <?= $isCollapsed ? 'collapsed-card' : '' ?>" data-prefix="<?= $prefix ?>" data-card-id="<?= $prefix ?>">
    <div class="card-header">
        <h5 class="card-title mb-0">Tabela de Causa de Pedir (tab_causa_pedir)</h5>
    ...
    <div class="card-body">
        ...
        <div class="row mt-3">
            <?php
            $mappingFields = ['descricao', 'id_integracao_api']; // O id_causa_pedir é gerado automaticamente
