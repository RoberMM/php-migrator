<?php
/**
 * src/View/partials/juizo_table_form.php
 * Componente de formulário para a Tabela de Juízo.
 */
$prefix = 'tabelaJuizo';
...
<div class="card card-dark mb-3 query-preview-component <?= $isCollapsed ? 'collapsed-card' : '' ?>" data-prefix="<?= $prefix ?>" data-card-id="<?= $prefix ?>">
    <div class="card-header">
        <h5 class="card-title mb-0">Tabela de Juízo (tab_juizo)</h5>
        ...
        <div class="card-body">
            ...
            <div class="row mt-3">
                <?php
                $mappingFields = ['descricao', 'cidade', 'estado', 'Info_complementares', 'id_municipio', 'id_integracao_api'];
