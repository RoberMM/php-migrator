<?php
/**
 * src/View/partials/grupo_trabalho_table_form.php
 * Componente de formulário para a Tabela de Grupo de Trabalho.(tab_grupo_trabalho)
 */
$prefix = 'tabelaGrupoTrabalho';
...
<div class="card card-dark mb-3 query-preview-component <?= $isCollapsed ? 'collapsed-card' : '' ?>" data-prefix="<?= $prefix ?>" data-card-id="<?= $prefix ?>">
    <div class="card-header">
        <h5 class="card-title mb-0">Tabela de Grupo de Trabalho (tab_grupo_trabalho)</h5>
    ...
    <div class="card-body">
        ...
        <div class="row mt-3">
            <?php
            $mappingFields = ['descricao', 'isProcessual', 'isFinanceiro', 'isCobranca'];
