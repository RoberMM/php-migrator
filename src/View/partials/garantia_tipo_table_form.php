<?php
/**
 * src/View/partials/garantia_tipo_table_form.php
 * Componente de formulário para a Tabela de Tipo de Garantia.
 */
$prefix = 'tabelaGarantiaTipo';
...
<div class="card card-dark mb-3 query-preview-component <?= $isCollapsed ? 'collapsed-card' : '' ?>" data-prefix="<?= $prefix ?>" data-card-id="<?= $prefix ?>">
    <div class="card-header">
        <h5 class="card-title mb-0">Tabela de Tipo Gatantia (tab_garantia_tipo)</h5>
    ...
    <div class="card-body">
        ...
        <div class="row mt-3">
            <?php
            // Apenas os campos que o usuário precisa mapear
            $mappingFields = ['descricao', 'codigo_formato_gra'];
