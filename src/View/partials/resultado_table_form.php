<?php
/**
 * src/View/partials/resultado_table_form.php
 * Componente de formulário para a Tabela de Resultado.
 */
$prefix = 'tabelaResultado';
...
<div class="card card-dark mb-3 query-preview-component <?= $isCollapsed ? 'collapsed-card' : '' ?>" data-prefix="<?= $prefix ?>" data-card-id="<?= $prefix ?>">
    <div class="card-header">
        <h5 class="card-title mb-0">Tabela de Resultado (tab_resultado)</h5>
        ...
        <div class="card-body">
            ...
            <div class="row mt-3">
                ...
                $mappingFields = ['descricao', 'aplicabilidade'];
