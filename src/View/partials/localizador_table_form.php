<?php
/**
 * src/View/partials/localizador_table_form.php
 * Componente de formulário para a Tabela de Localizador.
 */
$prefix = 'tabelaLocalizador';
...
<div class="card card-dark mb-3 query-preview-component <?= $isCollapsed ? 'collapsed-card' : '' ?>" data-prefix="<?= $prefix ?>" data-card-id="<?= $prefix ?>">
    <div class="card-header">
        <h5 class="card-title mb-0">Tabela de Localizador (tab_localizador)</h5>
    ...
    <div class="card-body">
        ...
        <div class="row mt-3">
            ...
            $mappingFields = ['sigla', 'descricao', 'tipo'];
