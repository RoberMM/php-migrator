<?php
/**
 * src/View/partials/situacao_table_form.php
 * Componente de formulário para a Tabela de Situação.
 */
$prefix = 'tabelaSituacao';
...
<div class="card card-dark mb-3 query-preview-component <?= $isCollapsed ? 'collapsed-card' : '' ?>" data-prefix="<?= $prefix ?>" data-card-id="<?= $prefix ?>">
    <div class="card-header">
        <h5 class="card-title mb-0">Tabela de Situação (tab_situacao)</h5>
