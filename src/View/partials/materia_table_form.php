<?php
/**
 * src/View/partials/materia_table_form.php
 * Componente de formulário para a Tabela de Matéria.
 */
$prefix = 'tabelaMateria';
...
<div class="card card-dark mb-3 query-preview-component <?= $isCollapsed ? 'collapsed-card' : '' ?>" data-prefix="<?= $prefix ?>" data-card-id="<?= $prefix ?>">
    <div class="card-header">
        <h5 class="card-title mb-0">Tabela de Matéria (tab_materia)</h5>
    ...
    <div class="card-body">
        ...
        <div class="row mt-3">
            ...
            $mappingFields = ['descricao', 'tipo', 'id_integracao_api'];
