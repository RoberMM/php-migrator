<?php
/**
 * src/View/partials/tema_table_form.php
 * Componente de formulário para a Tabela de Tema.
 */
$prefix = 'tabelaTema';
...
<div class="card card-dark mb-3 query-preview-component <?= $isCollapsed ? 'collapsed-card' : '' ?>" data-prefix="<?= $prefix ?>" data-card-id="<?= $prefix ?>">
    <div class="card-header">
        <h5 class="card-title mb-0">Tabela de Tema (tab_tema)</h5>
    ...
    <div class="card-body">
        ...
        <div class="row mt-3">
            ...
            $mappingFields = ['descricao', 'id_integracao_api'];
