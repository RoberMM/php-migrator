<?php
/**
 * src/View/partials/unidade_table_form.php
 * Componente de formulário para a Tabela de Unidade.
 */
$prefix = 'tabelaUnidade';
...
<div class="card card-dark mb-3 query-preview-component <?= $isCollapsed ? 'collapsed-card' : '' ?>" data-prefix="<?= $prefix ?>" data-card-id="<?= $prefix ?>">
    <div class="card-header">
        <h5 class="card-title mb-0">Tabela de Unidade (unidade)</h5>
    ...
    <div class="card-body">
        ...
        <div class="row mt-3">
            ...
            $mappingFields = ['id_pessoa', 'possui_financeiro', 'id_nfs_emitente'];
