<?php
/**
 * src/View/partials/orgao_julgador_table_form.php
 * Componente de formulário para a Tabela de Órgão Julgador.
 */
$prefix = 'tabelaOrgaoJulgador';
...
<div class="card card-dark mb-3 query-preview-component <?= $isCollapsed ? 'collapsed-card' : '' ?>" data-prefix="<?= $prefix ?>" data-card-id="<?= $prefix ?>">
    <div class="card-header">
        <h5 class="card-title mb-0">Tabela de Órgão Julgador (tab_orgao_julgador)</h5>
