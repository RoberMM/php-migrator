<?php
/**
 * src/View/partials/assunto_table_form.php
 * Componente de formulário para a Tabela de Assunto.
 */
$prefix = 'tabelaAssunto'; // <-- Variável principal ajustada
...
<div class="card card-dark mb-3 query-preview-component <?= $isCollapsed ? 'collapsed-card' : '' ?>" data-prefix="<?= $prefix ?>" data-card-id="<?= $prefix ?>">
    <div class="card-header">
            <h5 class="card-title mb-0">Tabela de Assunto (tab_assunto)</h5>
    ...
    <div class="card-body">
        ...
        <div class="row mt-3">
            <?php
            // LISTA DE CAMPOS ATUALIZADA para a tabela de assunto
            $mappingFields = ['sigla', 'descricao'];
